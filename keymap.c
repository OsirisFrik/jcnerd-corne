...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            TD(TD_W), LOWER, KC_SPC,     KC_SPC, RAISE, TD(TD_ALT)
                                      //|--------------------------|  |--------------------------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     CRTLZ, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLU, LALT(KC_G),                   KC_LEFT , KC_DOWN, KC_UP, KC_RIGHT, XXXXXXX, KC_DEL,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     CRTLZU, KC_MPLY, KC_MPRV, KC_MNXT, KC_VOLD, XXXXXXX,                     KC_LGUI , XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_W]= ACTION_TAP_DANCE_DOUBLE(KC_LCTRL, KC_LGUI)
};
